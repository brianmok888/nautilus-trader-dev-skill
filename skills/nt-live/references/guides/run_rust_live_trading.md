...
[integration guide](https://nautilustrader.io/docs/nightly/integrations/) for that venue.
...
`LiveNode` and is included in the pinned baseline `d2b62d35a7`; older pins through `6e59fd74ea`
