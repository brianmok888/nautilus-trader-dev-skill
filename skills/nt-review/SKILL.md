...
| G2 Pinned V2 examples | Changed Rust examples compile or have scoped harness evidence. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-review` passed against `f725e184dbd2f7432b5c7b9458b4ef6d1f85fd5f`; evidence: `references/g2-evidence/nt-review.json`. |
...
Validate review claims against the immutable snapshot under [`references/developer_guide/`](../../references/developer_guide/), particularly `rust.md`, `ffi.md`, `testing.md`, `benchmarking.md`, `adapters.md`, and `coding_standards.md`, pinned to commit `f725e184dbd2f7432b5c7b9458b4ef6d1f85fd5f`. Version-scope any newer upstream guidance until the pin advances.
