...
Install NautilusTrader using the [installation guide](https://nautilustrader.io/docs/latest/getting_started/installation/). The
...
- [Book imbalance backtest tutorial](https://github.com/nautechsystems/nautilus_trader/blob/73d4dd5b3be4cb198bb20c89da6963c85eb24f3a/docs/integrations/../tutorials/backtest_book_imbalance_betfair.md)
...
> **Live-funds warning:** Betfair's Delayed application key delays market data; it is not a paper-execution sandbox. Order examples can affect real funds. Validate data-only behavior first, keep execution disabled until reconciliation and risk limits are proven, and use a segregated minimally funded account.
>
> Load credentials from an ignored, permission-restricted environment file or deployment secret store. Never commit secrets, paste them into recorded shell sessions, or include environment dumps in findings and logs.
...
cumulative [`OrderFillVoided`](https://github.com/nautechsystems/nautilus_trader/blob/73d4dd5b3be4cb198bb20c89da6963c85eb24f3a/docs/integrations/../concepts/events/order_fill_voided.md) per affected `trade_id`. A
