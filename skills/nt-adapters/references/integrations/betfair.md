...
- All current Betfair work: [`betfair_v2.md`](betfair_v2.md) — the Rust adapter surface
  (`crates/adapters/betfair`), tracked against the pinned baseline `9bafb63e7d`.
- NT v2 compatibility note: the pinned upstream `docs/integrations/betfair.md` (pin `9bafb63e7d`)
