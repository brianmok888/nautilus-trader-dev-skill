...
The property is present at the pinned G2 baseline `1602043debb82b34084d35a452c374b744b96524`.
...
`Vec<Data>` load. `chunk_size` accepts 1..=1,000,000 (`MAX_BACKTEST_CHUNK_SIZE`,
upstream `4167c6db4`, `crates/backtest/src/config.rs`).
