...
| G2 Pinned V2 examples | Compile representative Rust API shapes against the pinned baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-architect` passed against `6df237382eb1d8411906f9b1790fa06f8ba7aad4`; evidence: `references/g2-evidence/nt-architect.json`. |
