...
| G2 Pinned V2 examples | Compile representative Rust API shapes against the pinned baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-architect` passed against `4692bac35bb11a25eeebb8d7af4d51c55afe53ec`; evidence: `references/g2-evidence/nt-architect.json`. |
