...
| G2 Pinned V2 examples | Compile representative Rust API shapes against the pinned baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-architect` passed against `baa667bc3c57cd3f639d9722b6fd592e4fcde36f`; evidence: `references/g2-evidence/nt-architect.json`. |
