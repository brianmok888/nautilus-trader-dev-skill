...
| G2 Pinned V2 examples | Compile representative Rust API shapes against the pinned baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-architect` passed against `1602043debb82b34084d35a452c374b744b96524`; evidence: `references/g2-evidence/nt-architect.json`. |
