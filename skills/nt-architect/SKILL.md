...
| G2 Pinned V2 examples | Compile representative Rust API shapes against the pinned baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-architect` passed against `8e51f957c6e31b28de14fbe244b3c048e291ddd7`; evidence: `references/g2-evidence/nt-architect.json`. |
