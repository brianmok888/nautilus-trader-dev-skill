...
| G2 Pinned V2 examples | Compile representative Rust API shapes against the pinned baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-architect` passed against `c1a2310144c37db80ad11af3d86b65b2ed300c81`; evidence: `references/g2-evidence/nt-architect.json`. |
