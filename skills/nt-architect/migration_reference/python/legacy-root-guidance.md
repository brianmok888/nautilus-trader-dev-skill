...
| G2 V2 example validation | Compile or validate examples applicable to this skill against the pinned NT V2 baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-architect` passed the skill domain's scoped examples and owners against `73d4dd5b3be4cb198bb20c89da6963c85eb24f3a`; schema-v2 provenance is recorded in `references/g2-evidence/nt-architect.json`. |
