...
The pinned upstream `MIGRATION_V2.md` (centralized by `beaac71e0`, version-scoped to `6df23738`) is the authoritative v1-vs-v2 comparison source for the migration lane.
...
| G2 Pinned V2 examples | Compile or validate examples applicable to this skill against the pinned NT V2 baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-trading` passed the skill domain's scoped examples and owners against `6df237382eb1d8411906f9b1790fa06f8ba7aad4`; schema-v2 provenance is recorded in `references/g2-evidence/nt-trading.json`. |
...
Source: upstream NautilusTrader pin `6df237382eb1d8411906f9b1790fa06f8ba7aad4`.
