...
The pinned upstream `MIGRATION_V2.md` (centralized by `beaac71e0`, version-scoped to `1602043d`) is the authoritative v1-vs-v2 comparison source for the migration lane.
...
| G2 Pinned V2 examples | Compile or validate examples applicable to this skill against the pinned NT V2 baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-trading` passed the skill domain's scoped examples and owners against `1602043debb82b34084d35a452c374b744b96524`; schema-v2 provenance is recorded in `references/g2-evidence/nt-trading.json`. |
...
Source: [`references/developer_guide/rust.md`](../../references/developer_guide/rust.md) at immutable commit `1602043debb82b34084d35a452c374b744b96524`.
...
Source: upstream NautilusTrader pin `1602043debb82b34084d35a452c374b744b96524`.
