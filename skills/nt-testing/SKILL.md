...
`1602043debb82b34084d35a452c374b744b96524` (verified 2026-09-02 via
...
| G2 Pinned V2 examples | Compile or validate examples applicable to this skill against the pinned NT V2 baseline. | Pass | `uv run python tools/check_skill_g2_harnesses.py --execute --skill nt-testing` passed the skill domain's scoped examples and owners against `1602043debb82b34084d35a452c374b744b96524`; schema-v2 provenance is recorded in `references/g2-evidence/nt-testing.json`. |
...
Current-develop overlay (reviewed through `1602043debb82b34084d35a452c374b744b96524`): every public PyO3
...
Use `references/developer_guide/testing.md`, `references/developer_guide/spec_data_testing.md`, `references/developer_guide/spec_exec_testing.md`, and `references/developer_guide/rust.md` as source-pinned upstream snapshots at commit `1602043debb82b34084d35a452c374b744b96524`. Keep the execution-spec freshness and nightly migration notes explicitly version-scoped.
...
- Treat upstream **Python v2 controller subclassing**, **subclassable execution
  ...
  At the pinned develop `1602043d` (in-pin since `d2b62d35a7`), change
