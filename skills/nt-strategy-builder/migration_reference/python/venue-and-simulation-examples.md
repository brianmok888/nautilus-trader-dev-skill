...
These examples document historical Python wiring only. They are not production defaults. New non-AI work routes to `nt-strategy-builder-rust`; the only active Python lane is AI/advisory work in `nt-evomap-integration`, off execution-critical paths.
