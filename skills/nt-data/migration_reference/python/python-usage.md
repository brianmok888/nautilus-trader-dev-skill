...
These accessors are available at the pinned baseline `1602043d` (see the current-lane guidance in this skill's SKILL.md). Use the `*_count` result as the authoritative count and the
