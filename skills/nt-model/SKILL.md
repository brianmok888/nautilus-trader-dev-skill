...
`9bafb63e7d75ab7033aff2e04cd6b4d45d14e9b7`. Use `new_checked` when code must
...
Use `references/developer_guide/rust.md` and the model snapshots under `references/api/model/` as source-pinned upstream material at commit `9bafb63e7d75ab7033aff2e04cd6b4d45d14e9b7`. Version-scope post-pin APIs such as `OrderInitialized::new_checked` until the baseline advances.
