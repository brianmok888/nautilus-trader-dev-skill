...
[NT-2026-08-16-01] [P0] [OPEN] Rust conversion correctness: custom-data guidance falsely describes current custom data as Python-only and recommends Python by default.
...
[NT-2026-08-16-02] [P1] [OPEN] V2 path drift: the DEX skill names removed `nautilus_trader/adapters/_template` as the canonical adapter skeleton.
...
[NT-2026-08-16-03] [P1] [OPEN] V2 path drift: execution-algorithm guidance names nonexistent `crates/exec-algo`.
...
[NT-2026-08-16-04] [P1] [OPEN] V2 path drift: backtest guidance treats `matching_core.rs` as a directory and recommends an unsupported arbitrary extension point.
...
[NT-2026-08-16-05] [P1] [OPEN] V2 path drift: duplicated DST guidance names removed `crates/live/src/manager.rs`.
...
[NT-2026-08-16-06] [P1] [OPEN] Legacy current-link drift: four instrument references link to removed Cython `margin.pyx` although margin accounting is Rust/PyO3.
...
[NT-2026-08-16-07] [P1] [OPEN] Current-develop contract gap: PyO3 actor subscription guidance omits the mandatory registration precondition.
...
[NT-2026-08-16-08] [P1] [OPEN] Current-develop contract gap: adapter guidance omits endpoint-scoped socket reconnect registration and outcomes.
...
[NT-2026-08-16-09] [P2] [OPEN] Current-develop improvement: benchmark guidance omits the canonical backtest workload matrix.
...
[NT-2026-08-16-10] [P2] [OPEN] Current-develop improvement: DEX guidance does not classify the upstream blockchain execution slice.
...
[NT-2026-08-16-11] [P1] [OPEN] Evidence freshness: the developer-guide sync gate is red because every source snapshot is older than its 14-day policy.
...
[NT-2026-08-16-12] [P1] [OPEN] Evidence freshness: the upstream delta review ends at an older develop revision and makes the freshness gate fail closed.
...
[NT-2026-08-16-13] [P1] [OPEN] Validation environment: the default upstream root points at moving develop while pinned validators require the G2 commit.
...
[NT-2026-08-16-14] [P1] [OPEN] Legacy lint fail-open: a readiness card containing G1 suppresses scanning of the entire root skill.
...
[NT-2026-08-16-15] [P1] [OPEN] Legacy lint fail-open: instructional Markdown below skill subdirectories is outside the mandatory scanner's scope.
...
[NT-2026-08-16-16] [P1] [OPEN] Repository boundary: shipped root skills still advertise an active AI/advisory Python lane despite the NT-only contract.
...
[NT-2026-08-16-17] [P2] [OPEN] Prose correctness: an nt-implement boundary sentence contains a dangling fragment from a partial lane edit.
