...
Below is an example configuration for a live node using Deribit data and execution clients (see
the shared [Live node wiring](index.md#live-node-wiring) pattern):
