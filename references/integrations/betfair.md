...
`docs/integrations/betfair.md` in the read-only pinned snapshot (pin `5e4be2edbf`) documents the
...
- Current Betfair work: follow the pinned upstream guide above; Rust-vs-historical differences
  and migration context are tracked in [`betfair_v2.md`](betfair_v2.md) against pin `5e4be2edbf`.
