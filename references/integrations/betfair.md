...
`docs/integrations/betfair.md` in the read-only pinned snapshot (pin `6df23738`) documents the
...
- Current Betfair work: follow the pinned upstream guide above; Rust-vs-historical differences
  and migration context are tracked in [`betfair_v2.md`](betfair_v2.md) against pin `6df23738`.
